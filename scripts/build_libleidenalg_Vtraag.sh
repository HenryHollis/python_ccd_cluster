...
if [ ! -d "libleidenalg" ]; then
  ...
  # git clone --branch ${LIBLEIDENALG_VERSION} https://github.com/HenryHollis/libleidenalg.git --single-branch
    git clone https://github.com/vtraag/libleidenalg.git --single-branch
